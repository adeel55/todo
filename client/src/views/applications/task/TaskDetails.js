                        ...
                        <Card>
                            ...
                            <Card.Body className='task-details'>
                                <Table >
                                    ...
                                    <tr>
                                        <td><i className="fas fa-line-chart m-r-5"/> Priority:</td>
                                    ...
                                    <tr>
                                        <td><i className="fas fa-refresh m-r-5"/> Revisions:</td>
                                ...
                                <ul className="media-list p-0">
                                    <li className="media d-flex m-b-15">
                                        <div className="m-r-20 file-attach">
                                            <i className="fas fa-file-word-o f-28 text-muted"/>
                                        </div>
                                        <div className="media-body">
                                    ...
                                    <li className="media d-flex m-b-15">
                                        <div className="m-r-20 file-attach">
                                            <i className="fas fa-file-powerpoint-o f-28 text-muted"/>
                                        </div>
                                        <div className="media-body">
                                    ...
                                    <li className="media d-flex m-b-15">
                                        <div className="m-r-20 file-attach">
                                            <i className="fas fa-file-pdf-o f-28 text-muted"/>
                                        </div>
                                        <div className="media-body">
                                    ...
                                    <li className="media d-flex m-b-15">
                                        <div className="m-r-20 file-attach">
                                            <i className="fas fa-file-excel-o f-28 text-muted"/>
                                        </div>
                                        <div className="media-body">
                        ...
                        <Card>
                            ...
                            <Card.Body>
                                ...
                                <div className="float-left">
                                    <span className=" txt-primary"> <i className="fas fa-line-chart"/> Status:</span>
