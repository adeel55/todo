                            ...
                            <Card>
                                <Card.Body>
                                    ...
                                    <Row className="mt-3 text-center">
                                        <Col>
                                            <h3 className="m-0"><i className="fas fa-circle f-10 m-r-5 text-success"/>674</h3>
                                            <span className="ml-3">New</span>
                                        </Col>
                                        <Col>
                                            <h3 className="m-0"><i className="fas fa-circle text-primary f-10 m-r-5"/>182</h3>
                                ...
                                <Card.Body>
                                    <Row>
                                        ...
                                        <Col className="text-right">
                                            ...
                                            <span className="text-white">8.2%<i className="feather icon-trending-up ml-1"/></span>
                                        </Col>
                                    </Row>
                                    <Chart {...customerChart1} />
                                    <Row className="mt-3 text-center">
                                        <Col>
                                            <h3 className="m-0 text-white"><i className="fas fa-circle f-10 m-r-5 text-success"/>674</h3>
                                            <span className="ml-3">New</span>
                                        </Col>
                                        <Col>
                                            <h3 className="m-0 text-white"><i className="fas fa-circle f-10 m-r-5 text-white"/>182</h3>
                                            <span className="ml-3">Return</span>
                                        </Col>
                                    </Row>
                                </Card.Body>
